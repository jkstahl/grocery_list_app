...
//                null, null, null, null, null);
    ...
    public Cursor getAllRecipes(final String filterString) {
        ...
        */
        ...
        Cursor reciepeCursor = db.rawQuery("SELECT RECIPES._id, NAME, INSTRUCTIONS, COUNT(RECIPE_LIST._id) AS RECCOUNT, RECIPE_LIST.TIMESTAMP FROM RECIPES LEFT JOIN RECIPE_LIST ON RECIPES._id = RECIPE_LIST.RECIPE_ID WHERE NAME LIKE ? GROUP BY NAME ORDER BY RECCOUNT DESC, RECIPE_LIST.TIMESTAMP DESC", queryArgs);
